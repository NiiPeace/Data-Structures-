...
print('a) Moment when x = 0 is' + str(M) + 'KN/m') 
print() 
print('V when x = 0 is V = ' + str(V) + 'KN')


x = 12
M = (w * (-6*x**2 + 6*L*x - L**2))/12
print()
print('Moment when x = 12 is'+ str(M) +'KN/m')

V = w * ((L/2) - x) 
print()
print('V when x = 12 is' + str(V) + 'KN')
...
step = 0.01 
S = L + step 
x = np.arange(start,S,step)
V = w*(L/2 - x) 
print()
print('(e) The shear force is {}'.format(V))
...
max_S = max(BMoment_values) 
min_S = min(BMoment_values)
print()
print("h) Maximum bending moment:", max_S) 


print()
print("Minimum bending moment:", min_S) 
